	...
	i = {
		...
		_generatePreviewTemplate: function(t, a, r, n, o, l, s, d, c, p, u) {
			var f, m = this,
				g = m.slug(r),
				v = "",
				h = m.previewSettings[t] || m.defaults.previewSettings[t],
				w = h && h.width ? h.width : "",
				_ = h && h.height ? h.height : "",
				b = c || m._renderFileFooter(g, s, i.isEmpty(w) ? "auto" : w, l),
				C = m._getPreviewIcon(r),
				y = "type-default",
				E = C && m.preferIconicPreview,
				x = C && m.preferIconicZoomPreview,
				T = function(a, l, s, c) {
					var f = s ? "zoom-" + o : o,
						v = m._getPreviewTemplate(a),
						h = (d || "") + " " + c;
		...
		_validateAllImages: function() {
			...
			if(n === a.totalImagesCount && (a._raise("fileimagesloaded"), a.resizeImage))
				for(e = 0; e < a.loadedImages.length; e++) i = a.loadedImages[e], i.validated || (t = i.siz, t && t > 1e3 * o && a._getResizedImage(i, r, n), a.loadedImages[e].validated = !0)
		},
